...
This essay is not going to talk about how to get the best results from a coding
...
everything those agents produce.
...
followed the same UI standards.
...
than it would have to stay in sync as you went.

To make matters worse, instead of Janet and George getting on the same page it
...
## Impact isn't truly understood until an artifact exists
...
For one person poking at an idea on their own, that's can be a good thing. On a
...
got cheap but understanding what got built didn't.
...
opinions and questions are the actual value you bring.
...
part doesn't get any bigger no matter how many agents you add.
...
The agents are working in parallel, but all of that work has to come back
...
the corner for any team doing this long term.
...
happens. The thinking it was supposed to carry quietly drops out.
...
these risks and build their habits around them.
